"""
Fichier : 'personnage2.py'
Contenu : Stats du personnnage 2
...
from Personnages.Koopa import Stats as Koopa

class Player(pygame.sprite.Sprite):
    
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.combattant=Koopa
        self.name="player2"
        ...
        self.rect = pygame.Rect(1080,50,self.combattant.taille[0],self.combattant.taille[1])  
        ...
        self.posMort=[]
        self.lieuMort=''
        self.spawnPoint=(1080,50)
        self.moveKeys=v.keysTaken[6:12]
    ...
    class carrerouge:
        ...
        def __init__(self):
            ...
            self.rect = pygame.Rect(10000,10000,20,20)
