...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self): 
        ...
        self.displayedImage=self.combattant.immobile[0]
        self.image.fill((255,255,255))
        self.rect = pygame.Rect(200,50,self.combattant.taille[0],self.combattant.taille[1])  
        ...
        if self.isAttacked and self.combattant.hit!=0:
            ...
            if self.attaque=='up' and self.combattant.attaqueUp!=[]:   
                ...
                if self.orientation=='Gauche':
                    ...
                    screen.blit(self.combattant.attaque[n//self.combattant.speedAnim],(self.rect.x+self.combattant.offset[0],self.rect.y+self.combattant.offset[1]+self.combattant.immobile[0].get_size()[1]-self.combattant.attaque[n//self.combattant.speedAnim].get_size()[1]))
